...
import { ContextMode } from '@/lib/types/common'
...
export function SourcesColumn({
  ...
  const collapseButton = useMemo(
    () => createCollapseButton(toggleSources, t('section.sources')),
    [toggleSources, t]
  )
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      await deleteSource.mutateAsync({ id: sourceToDelete, notebookId })
  ...
  return (
    <>
      <CollapsibleColumn
        ...
        collapsedLabel={t('section.sources')}
      >
        <Card className="h-full flex flex-col flex-1 overflow-hidden">
          <CardHeader className="pb-3 flex-shrink-0">
            <div className="flex items-center justify-between gap-2">
              <CardTitle className="text-lg">{t('section.sources')}</CardTitle>
      ...
      <ConfirmDialog
        ...
        description={t('source.removeDescription')}
