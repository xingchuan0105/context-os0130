...
import { ContextMode, ContextSelections } from '@/lib/types/common'
...
export function NotesColumn({
  ...
  const collapseButton = useMemo(
    () => createCollapseButton(toggleNotes, t('section.notes')),
    [toggleNotes, t]
  )
  ...
  return (
    <>
      <CollapsibleColumn
        ...
        collapsedLabel={t('section.notes')}
      >
        <Card className="h-full flex flex-col flex-1 overflow-hidden">
          <CardHeader className="pb-3 flex-shrink-0">
            <div className="flex items-center justify-between gap-2">
              <CardTitle className="text-lg">{t('section.notes')}</CardTitle>
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-xs text-muted-foreground">
                          {formatDistanceToNow(new Date(note.updated), { addSuffix: true, locale: dateLocale })}
                        </span>
