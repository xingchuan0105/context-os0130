...
import { useSourceChatV2 } from '@/lib/hooks/useSourceChatV2'
...
export default function SourceDetailPage() {
  ...
  // Initialize source chat with V2 (Vercel AI SDK)
  const chat = useSourceChatV2(sourceId, locale)
