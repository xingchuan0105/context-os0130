...
const defaultConfigs: DefaultConfig[] = [
  {
    ...
    descriptionKey: 'models.defaults.chat.description',
    modelType: 'language',
    required: true
  },
  {
    ...
    descriptionKey: 'models.defaults.transformation.description',
    modelType: 'language',
    required: true
  },
  {
    ...
    descriptionKey: 'models.defaults.tools.description',
    modelType: 'language'
  },
  {
    key: 'large_context_model',
    labelKey: 'models.defaults.largeContext.label',
    descriptionKey: 'models.defaults.largeContext.description',
    modelType: 'language'
  },
  {
    key: 'default_embedding_model',
    labelKey: 'models.defaults.embedding.label',
    descriptionKey: 'models.defaults.embedding.description',
    modelType: 'embedding',
    required: true
  },
  {
    key: 'default_text_to_speech_model',
    labelKey: 'models.defaults.textToSpeech.label',
    descriptionKey: 'models.defaults.textToSpeech.description',
    modelType: 'text_to_speech'
  },
  {
    key: 'default_speech_to_text_model',
    labelKey: 'models.defaults.speechToText.label',
    descriptionKey: 'models.defaults.speechToText.description',
...
export function DefaultModelsSection({ models, defaults }: DefaultModelsSectionProps) {
  ...
  const missingRequired = defaultConfigs
    ...
    .map(config => t(config.labelKey as any))
      ...
      <CardContent className="space-y-6">
        {missingRequired.length > 0 && (
          <Alert>
            ...
            <AlertDescription>
              {t('models.defaults.missingRequired', { models: missingRequired.join(', ') })}
            </AlertDescription>
          </Alert>
        )}
                  ...
                  >
                    <SelectTrigger className={
                      ...
                      <SelectValue placeholder={
                        config.required && !isValidModel && availableModels.length > 0 
                          ? t('models.defaults.requiredPlaceholder')
                          : t('models.defaults.placeholder')
                      } />
                    </SelectTrigger>
                    <SelectContent>
