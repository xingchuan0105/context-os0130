    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t('transformations.playgroundDescription')}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="transformation">{t('transformations.label')}</Label>
              <Select value={selectedId} onValueChange={setSelectedId}>
                <SelectTrigger id="transformation">
                  <SelectValue placeholder={t('transformations.selectPlaceholder')} />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              <ModelSelector
                ...
                value={modelId}
                onChange={setModelId}
                placeholder={t('models.defaults.placeholder')}
              />
            </div>
          </div>
