      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {t('source.associationsTitle')}
          </CardTitle>
          <CardDescription>
            {t('source.associationsDescription')}
          </CardDescription>
        </CardHeader>
        <CardContent>
  ...
  if (!notebooks || notebooks.length === 0) {
    return (
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">{t('source.associationsEmpty')}</p>
        </CardContent>
      </Card>
    )
  }
            ...
            >
              {isSaving ? (
                <>
                  ...
                  {t('source.associationsSaving')}
                </>
              ) : (
                t('source.associationsSave')
              )}
            </Button>
          </div>
        )}
